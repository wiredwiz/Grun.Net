...
{
   public partial class LexerSelector : Form
   {
      private IEnumerable<GrammarReference> _GrammarsToSelectFrom;

      public LexerSelector()
      {
         InitializeComponent();
      }
      ...
      public IEnumerable<GrammarReference> GrammarsToSelectFrom
      {
         ...
         set
         {
            ...
            LexerListView.SetObjects(_GrammarsToSelectFrom);
         }
      }
      ...
      {
         SelectedGrammar = LexerListView.SelectedItem?.RowObject as GrammarReference;
